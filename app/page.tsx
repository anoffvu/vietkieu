      ...
      <div className="bg-[#FFFF00] text-[#DA251D] font-['Playfair_Display',serif] flex flex-col justify-between min-h-screen text-center overflow-x-hidden">
        <main className='flex-1 flex justify-center items-center'>
          <div className='max-w-[800px] p-5 relative'>
            ...
            <h2 className='text-xl sm:text-2xl mt-2 mb-3 sm:mb-5 font-normal transform skew-x-5 [text-shadow:3px_3px_0px_rgba(218,37,29,0.3)]'>
              (Overseas Vietnamese)
            </h2>
            <div className='flex flex-col items-center gap-3 sm:gap-5 mt-5 sm:mt-10'>
              <a
                href='https://www.instagram.com/mam.nyc'
                target='_blank'
                rel='noopener noreferrer'
                className='text-xl sm:text-2xl no-underline p-2 sm:p-2.5 transform -skew-x-5 transition-all duration-300 ease-in-out w-full max-w-[300px] inline-block [text-shadow:3px_3px_0px_rgba(218,37,29,0.3)] hover:scale-110 hover:transform hover:skew-x-5 hover:[text-shadow:3px_3px_0px_rgba(218,37,29,0.5)]'
              >
                Mam
              </a>
              <a
              ...
              <a
                ...
                target='_blank'
                rel='noopener noreferrer'
                className='text-xl sm:text-2xl no-underline p-2 sm:p-2.5 transition-all duration-300 ease-in-out w-full max-w-[300px] inline-block [text-shadow:3px_3px_0px_rgba(218,37,29,0.3)] hover:scale-110 hover:[text-shadow:3px_3px_0px_rgba(218,37,29,0.5)] animate-vibrate'
              >
